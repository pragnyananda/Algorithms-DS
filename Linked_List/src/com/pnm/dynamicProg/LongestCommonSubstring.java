package com.pnm.dynamicProg;

public class LongestCommonSubstring {

    /**
     * Dynamic way of calculating lcs  //https://www.youtube.com/watch?v=BysNXJHzCEs
     */
    public int longestCommonSubstring(char str1[], char str2[]){
        ...
        System.out.println("LongestCommonSubstring is : " + s.toString());
        return max;
    }
